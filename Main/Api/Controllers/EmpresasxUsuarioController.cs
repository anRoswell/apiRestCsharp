...
namespace Api.Controllers
{
    ...
    public class EmpresasxUsuarioController : ControllerBase
    {
        ...
        [Consumes("application/json")]
        public async Task<IActionResult> CreateEmpresaXusuario([FromBody] PermisosEmpresasxUsuario empresasxUsuario)
        {
            try
            {
        ...
        [Consumes("application/json")]
        public async Task<IActionResult> UpdateEmpresaXusuario([FromBody] PermisosEmpresasxUsuario empresasxUsuario)
        {
            try
            {
