...
{
    public class PerfilesXusuarioConfiguration : IEntityTypeConfiguration<PerfilesXusuario>
    {
        public void Configure(EntityTypeBuilder<PerfilesXusuario> builder)
        {
            builder.HasKey(e => e.Id)
                    .HasName("PK__Perfiles__A6E8FE4D7DD8D933");

            builder.ToTable("PerfilesXUsuarios", "usr");
            ...
            builder.HasOne(d => d.PxuAplCodAplicacionNavigation)
                .WithMany(p => p.PerfilesXusuarios)
                .HasForeignKey(d => d.PxuAplCodAplicacion)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_PerfilesXUsuarios_Aplicacion");

            builder.HasOne(d => d.PxuPrfCodPerfilNavigation)
                .WithMany(p => p.PerfilesXusuarios)
                .HasForeignKey(d => d.PxuPrfCodPerfil)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_PerfilesXUsuarios_Perfil");
        }
    }
}
