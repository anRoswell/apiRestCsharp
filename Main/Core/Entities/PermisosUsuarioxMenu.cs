...
namespace Core.Entities
{
    public partial class PermisosUsuarioxMenu : BaseEntity
    {
        ...
        public virtual Aplicacion PumAplCodAplicacionNavigation { get; set; }
        public virtual Menu PumMenCodMenuNavigation { get; set; }
        public virtual Usuario PumUsrCodUsuarioNavigation { get; set; }
    }
}
